...
'aria-label': ariaLabel, 'aria-labelledby': ariaLabelledBy, 'aria-describedby': ariaDescribedBy }, ref) {
    ...
    function handleRowChange(row, commitChanges) {
        ...
        if (commitChanges) {
            ...
            setSelectedPosition(position => (Object.assign(Object.assign({}, position), { row })));
        }
    }
    ...
    function selectCell(position, enableEditor = false) {
        ...
        if (enableEditor && isCellEditable(position)) {
            ...
            setSelectedPosition(Object.assign(Object.assign({}, position), { mode: 'EDIT', key: null, row, originalRow: row }));
        }
        else {
